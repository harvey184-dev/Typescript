...
async function doc(courseApi: string): Promise<any> {
    try {
...
function updateCart(cart: Product[]): void {
...
async function giohang(id_product: string): Promise<void> {
    try {
...
function addadd(): void {
    ...
    const name = (document.getElementById('name') as HTMLInputElement).value || customer.customer_name; // Sử dụng thông tin khách hàng nếu có
    const sodienthoai = (document.getElementById('sodienthoai') as HTMLInputElement).value || customer.customer_phone;
    const diachi = (document.getElementById('diachi') as HTMLInputElement).value || customer.customer_address;
    const email = (document.getElementById('email') as HTMLInputElement).value || customer.customer_email;
    const noidung = (document.getElementById('noidung') as HTMLInputElement).value;
