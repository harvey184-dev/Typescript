...
export const productcategory = async (id_category_product) => {
    let data = await fetch(`http://localhost:3000/category_product/${id_category_product}`)
        .then(res => res.json()).then(data => data);
    let text = ``;
    data.forEach(p => {
...
export const namecategory = async (id_category_product) => {
    let data = await fetch(`http://localhost:3000/category_product/${id_category_product}`)
        .then(res => res.json()).then(data => data[0]);
    let text = `${data.title_category_product}`;
    return text;
};
export const productbyproduct = async (id_product) => {
...
export const detailproduct = async (id_product) => {
...
export const tag = async (id_product) => {
    let data = await fetch(`http://localhost:3000/detail_product/${id_product}`)
        .then(res => res.json()).then(data => data[0]);
