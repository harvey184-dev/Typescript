export function addCategoryProduct() {
    document.getElementById('add_category_form')?.addEventListener('submit', function (event) {
        ...
        let title_category_product = document.getElementById('title_category_product')?.value;
        let desc_category_product = CKEDITOR.instances.editor?.getData();
        let data = {
...
export function editCategoryProduct(id_category_product) {
...
export const editProduct = (id_product) => {
...
export const ep = async (id_product) => {
...
export const ecp = async (id_category_product) => {
...
export const xoasp = async (id_product) => {
    try {
...
export const xoadmsp = async (id_category_product) => {
    try {
