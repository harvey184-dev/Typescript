...
export function editCategorypost(id_category_post) {
...
export const ecp = async (id_category_post) => {
...
export const xoadmbv = async (id_category_post) => {
    try {
...
export const xoabv = async (id_post) => {
    try {
...
export function editpost(id_post) {
